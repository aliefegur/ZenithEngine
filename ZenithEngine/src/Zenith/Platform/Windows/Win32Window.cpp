...
#define	ZENITH_WND_EXCEPT(hr) Zenith::Win32Window::HrException(__LINE__, __FILE__, hr)
#define ZENITH_WND_LASTEXCEPT() Zenith::Win32Window::HrException(__LINE__, __FILE__, GetLastError())
...
#pragma region Win32Window
	...
	{
		Window::SetFullscreenState(fullScreen);
		// TODO: Implement this
	}
